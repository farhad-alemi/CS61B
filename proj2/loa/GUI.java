...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->Retract", param -> _pendingCommands
                .offer("retract"));
        addMenuButton("Game->Quit", this::quit);
        addMenuButton("Setting->Auto Black", param -> _pendingCommands
                .offer("auto black"));
        addMenuButton("Setting->Auto White", param -> _pendingCommands
                .offer("auto white"));
        addMenuButton("Setting->Manual Black", param -> _pendingCommands
                .offer("manual black"));
        addMenuButton("Setting->Manual White", param -> _pendingCommands
                .offer("manual white"));
        addMenuButton("More->Help", param -> displayText("Help", HELP_TEXT));
        addMenuButton("More->About", param -> displayText
                ("LOA CS61B - Version 2.0", ABOUT_TEXT));
